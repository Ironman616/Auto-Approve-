...
class Config:
    ...
    UPDATE_CHANNEL = getenv("UPDATE_CHANNEL", "Movie_Loverzz")
    ...
    RKN_PIC = os.environ.get("RKN_PIC", "https://graph.org/file/a319f6b9ce3b993c6e22f.jpg")
    BOT_USERNAME = os.environ.get("BOT_USERNAME","AutoAcceptibot")
